...
const SignIn = (): JSX.Element => {
  ...
  const notifySignInSuccess = () => toast.success(jaTranslate('success.action', 'actions.signIn'));
  const notifySignInFailure = () => toast.error(jaTranslate('failure.action', 'actions.signIn'));
